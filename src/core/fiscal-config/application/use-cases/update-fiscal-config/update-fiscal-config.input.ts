...
export type UpdateFiscalConfigInputConstructorProps = {
  id: string;
  store_id: string;
  config_name?: string;
...
export class UpdateFiscalConfigInput {
  @IsString()
  @IsNotEmpty()
  id: string;
  ...
  constructor(props: UpdateFiscalConfigInputConstructorProps) {
    if (!props) return;
    this.id = props.id;
...
export class ValidateUpdateFiscalConfigInput {
  static validate(input: UpdateFiscalConfigInput) {
